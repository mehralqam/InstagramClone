...
ActiveRecord::Schema.define(version: 20_220_516_132_312) do
  ...
  create_table 'followrequests', force: :cascade do |t|
    ...
    t.string 'user_name'
    t.index %w[follow_user_id user_id], name: 'index_followrequests_on_follow_user_id_and_user_id', unique: true
  end
  ...
  create_table 'followships', force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[follower_id user_id], name: 'index_followships_on_follower_id_and_user_id', unique: true
  end
